<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptSCEPayList.aspx.cs" Inherits="GAFPAY.Reports.rptSCEPayList" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="800px" Width="1200px" Font-Names="Verdana" Font-Size="8pt" ProcessingMode="Remote" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <ServerReport ReportPath="/GAFPAYReports/rptSCEPayList" />
        </rsweb:ReportViewer>
    </form>
</body>
</html>
