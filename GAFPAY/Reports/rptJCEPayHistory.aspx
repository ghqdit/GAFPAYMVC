<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptJCEPayHistory.aspx.cs" Inherits="GAFPAY.Reports.rptJCEPayHistory" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="800px" ProcessingMode="Remote" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1200px">
            <ServerReport ReportPath="/GAFPAYReports/rptJCEPayHistory" />
        </rsweb:ReportViewer>
